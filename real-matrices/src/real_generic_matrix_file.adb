...
package body Real_Generic_Matrix_File is
   
   function Load_Real_Matrix ( File : in File_Type ) return Real_Matrix is
      M, N : Integer;
   begin
      Get (File, M);
      Get (File, N);
   ...
   function Load_Real_Matrix ( File_Name : String ) return Real_Matrix is
      File : File_Type;
   begin
