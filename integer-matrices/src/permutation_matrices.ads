...
private
   ...
   function Unity (N : Positive) return Permutation_Matrix_Array
     ...
     Post => Each_Column_Has_One_Unity (Unity'Result) and then Each_Column_Has_One_Unity (Unity'Result);
   ...
   type Permutation_Matrix (N : Positive) is record
     ...
     with Type_Invariant => Each_Column_Has_One_Unity (Permutation_Matrix.A) and then Each_Column_Has_One_Unity (Permutation_Matrix.A);
